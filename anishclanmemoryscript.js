...
// Items array
const items = [
    {name: "bear", word: "makwa", image: "bear.png", audio: "makwa.mp3"},
    {name: "deer", word: "waawaashkeshi", image: "deer.png", audio: "waawaashkeshi.mp3"},
    {name: "eagle", word: "mgizi", image: "eagle.png", audio: "mgizi.mp3"},
    {name: "fish", word: "giigoonh", image: "fish.png", audio: "giigoonh.mp3"},
    {name: "wolf", word: "ma'iingan", image: "wolf.png", audio: "maiingan.mp3"},
    {name: "bird", word: "benaishii", image: "bird.png", audio: "benaishii.mp3"},
    {name: "turtle", word: "mikinaak", image: "turtle.jpeg", audio: "mikinaak.mp3"},
    {name: "beaver", word: "amik", image: "beaver.png", audio: "amik.mp3"},
    {name: "crane", word: "aajiijak", image: "crane.png", audio: "aajiijak.mp3"},
    {name: "loon", word: "maang", image: "loon.png", audio: "maang.mp3"},
    {name: "marten", word: "waabizheshi", image: "marten.png", audio: "waabizheshi.mp3"},
    {name: "heron", word: "shagi", image: "heron.png", audio: "shagi.mp3"},
    {name: "hawk", word: "memeskniniisi", image: "hawk.png", audio: "memeskniniisi.mp3"},
];
        ...
        */
        ...
        gameContainer.innerHTML += `
            <div class="card-container" data-card-value="${cardValues[i].name}" data-audio-value="${cardValues[i].audio}">
                ...
                <div class="card card-after"><p class="card-title m3">${cardValues[i].word}</p><img src="${cardValues[i].image}" class="image"><p class="card-text m3">${cardValues[i].name}</p></div>
            </div>
            `;
    }
    // Grid
